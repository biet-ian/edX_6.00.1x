...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i,l in enumerate(string.ascii_lowercase):
            shift_dict[l] = string.ascii_lowercase[(i+shift)%len(string.ascii_lowercase)]
        for i,l in enumerate(string.ascii_uppercase):
            shift_dict[l] = string.ascii_uppercase[(i+shift)%len(string.ascii_uppercase)]
        return shift_dict
    ...
    def apply_shift(self, shift):
        ...
        for c in self.message_text:
            if c in string.punctuation or c == ' ' or c in string.digits:
                cipher_text += c
            else:
                cipher_text += shift_dict[c]
        return cipher_text
    ...
    def decrypt_message(self):
        ...
        for shift in range(len(string.ascii_lowercase)):
            ...
            for word in decrypted_words:
                word_count += is_word(self.get_valid_words(),word)
            if word_count > valid_word_count:
